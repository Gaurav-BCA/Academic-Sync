...
export const LeaderboardScreen: React.FC = () => {
  ...
  return (
    <div className="space-y-6 py-4 max-w-[1240px] mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 stealth-card p-6 bg-white border border-amber-100 rounded-3xl shadow-sm">
        ...
        <div className="flex items-center space-x-1 bg-amber-50/60 p-1 rounded-full border border-amber-200/50 shrink-0">
          ...
          <button
            ...
            className={`px-4 py-1.5 rounded-full text-xs font-mono transition-all ${
              activeFilter === 'faculty' ? 'bg-white text-[#FF6B4B] font-bold shadow-xs border border-orange-200' : 'text-neutral-600 hover:text-neutral-900'
            }`}
          >
            Verification Ratio
          </button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 stealth-card p-6 space-y-4 bg-white border border-amber-100 rounded-3xl shadow-sm">
                    ...
                    >
                      ...
                      <td className="py-3.5 px-2">
                        <div className="flex items-center space-x-3">
                          <div className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-xs tnum ${
                          ...
                          <div>
                            <div className="flex items-center space-x-2">
                              <span className="text-neutral-900 text-sm font-jakarta font-bold">{displayName}</span>
                            ...
                            <span className="text-[10px] text-neutral-500 font-semibold tnum">{displayRollNumber}</span>
                          </div>
                        </div>
                      </td>
          ...
          <div className="pt-4 border-t border-amber-100 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs font-mono text-neutral-600">
            <span className="tnum font-medium">Showing top {topCount} of {totalStudents} students in Sem VI-A.</span>
            <button
              onClick={handleExportCSV}
              className="btn-stealth px-4 py-2 text-xs font-mono flex items-center space-x-2 shadow-xs"
            >
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="stealth-card p-6 space-y-4 bg-white border border-amber-100 rounded-3xl shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-2 bg-amber-50/60 border border-amber-200/60 p-3 rounded-2xl text-center font-mono text-xs">
              <div>
                <span className="text-[10px] text-neutral-500 block font-bold">Pending Reviews</span>
                <span className="text-neutral-900 font-bold text-sm tnum">0</span>
              </div>
              <div>
                <span className="text-[10px] text-neutral-500 block font-bold">Present Ratio (Sample)</span>
                <span className="text-emerald-700 font-bold text-sm tnum">38 / 46</span>
              </div>
            </div>
          ...
          <div className="stealth-card p-6 space-y-4 bg-white border border-amber-100 rounded-3xl shadow-sm">
            ...
            <p className="text-xs text-neutral-600 leading-relaxed font-sans">
              Your profile <span className="text-neutral-900 font-mono font-bold">(Roll No: {studentProfile?.rollNumber || '21CS045'})</span> has maintained consistent attendance over 64 consecutive days, maintaining Gold tier standing.
            </p>
